...
2. Huang, J., Yao, Y., & Divakaran, A. (2025). Transforming Causality: Transformer-Based Temporal Causal Discovery with Prior Knowledge Integration. ArXiv.org. https://arxiv.org/abs/2508.15928
3. Assaad C, Devijver E, Gaussier E. 2022. Entropy-Based Discovery of Summary Causal Graphs in Time Series. Entropy. 24(8):1156–1156. doi:https://doi.org/10.3390/e24081156.
4. The ultimate guide to generating synthetic data for causal inference | Program Evaluation. (2020). Program Evaluation; PMAP 8141: Program Evaluation. https://evalsp21.classes.andrewheiss.com/example/synthetic-data/
